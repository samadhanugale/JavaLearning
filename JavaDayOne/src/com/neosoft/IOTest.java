...
public class IOTest {
	public static void main(String[] args) throws IOException {
		...
		while((line = br2.readLine())!=null) {
			...
			BufferedWriter br4 = new BufferedWriter(new FileWriter(file2,true)); //Append mode, if true removed rewrite mode
			br4.newLine();
			br4.write(line);
			br4.close();
		}
		...
		BufferedWriter br3 = new BufferedWriter(new FileWriter(file1,true)); //Append mode, if true removed rewrite mode
		br3.newLine();
